...
import 'package:wetrek/main.dart';
...
//  });
  ...
  test('treks parse correctly', () async {
//    final Paginated<Trek> res = await TrekRepository('token').list(Parameters());
    final Map<String, dynamic> loginRes = await API.postWithoutToken(
      '/login',
      {'email': 'ekenemadunagu@gmail.com', 'password': 'mercy'},
    );
    final String token = loginRes['token'];
    final API api = API(token);
    final Map<String, dynamic> res =
        await api.get('/treks', params: Parameters().toJson());
